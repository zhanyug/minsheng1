...
module.exports = {
    getImageBase64: function(EXIF, inputId, viewId, afterWidth, callback) {
            ...
            reader.onload = function(evt) {
                ...
                p.onload = function() {
                    ...
                    if (upImgWidth < 10 || upImgWidth < 10) {
                        ...
                        // canvas绘制压缩后图片
                        _this.drawImageIOSFix(hidCtx, p, 0, 0, upImgWidth, upImgHeight, 0, 0, afterWidth, afterHeight);
                        // 获取压缩后生成的img对象
                        viewImg.src = _this.convertCanvasToImage(hidCanvas).src;
                        self.value = "";
                        // 此处将得到的图片数据回调
                        if (callback != undefined) {
                            callback(viewImg.src)
                        };
                    }
                }
            }
    ...
    onchangeImageBase64: function(EXIF, inputId, viewId, afterWidth, callback) {
