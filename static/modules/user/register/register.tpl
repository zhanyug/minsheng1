    ...
    <div class="mui-content content">
        ...
        <div class="RegisterOne_img">
       		<!--<ul>
	            ...
	            <ul id="navall">
	                <li><a v-bind:class="{'selectedall': navClass=='0'}" v-on:click="toGetInfo('0')"><p>注册信息</p></a></li>
	                <li><a v-bind:class="{'selectedall': navClass=='1'}" v-on:click="toGetInfo('1')"><p>实名认证</p></a></li>
	                <li><a v-bind:class="{'selectedall': navClass=='2'}" v-on:click="toGetInfo('2')"><p>交易密码</p></a></li>
